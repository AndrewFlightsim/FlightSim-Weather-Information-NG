...
namespace FSWeatherInformation.Core.WeatherStrings
{
    ...
    /// </summary>
    public sealed class MetarString : WeatherString
    {
        /// <summary>
        ...
        /// </exception>
        public MetarString([NotNull] IcaoCode icaoCode, string _string, bool found, WeatherSource source) :
            base(icaoCode, Normalizer.Normalizer.GetNormalizedMetarStringFrom(found, _string, icaoCode), found, source)
        {
        }
    }
}