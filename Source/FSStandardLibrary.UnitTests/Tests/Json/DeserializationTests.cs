...
using FSStandardLibrary.Core.Json;
...
namespace FSStandardLibrary.UnitTests.Tests.Json
{
    ...
    public class DeserializationTests
    {
        public static IEnumerable<object[]> ValidDataForCreatingSampleClassData
        {
            get
            {
                ...
                foreach (var icaoCode in IcaoCodes.ValidStringIcaoCodesCollection)
                {
                    foreach (var validString in Strings.ValidStrings)
                    {
