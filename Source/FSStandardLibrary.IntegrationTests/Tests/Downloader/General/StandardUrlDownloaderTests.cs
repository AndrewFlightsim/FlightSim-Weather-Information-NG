...
using FSStandardLibrary.Implementations.Downloader.General;
using NUnit.Framework;

#endregion

namespace FSStandardLibrary.IntegrationTests.Tests.Downloader.General
{
    ...
    public class StandardDownloaderTests
    {
            ...
            DownloadForManyRequestsAsync_WithMixedValidAndInvalidDownloadRequests_ShouldDownload_SomethingWithNotNullResult()
        {
            ...
            List<UrlDownloadRequest> listOfRequests = new List<UrlDownloadRequest>
            {
                ...
                new UrlDownloadRequest(new Uri("https://www.yahoo.com/"))
            };
            ...
            //Assert
            resultList.Should().NotBeEmpty().And.HaveCount(3).And.OnlyContain(item =>
